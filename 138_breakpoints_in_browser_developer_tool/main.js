...
console.log("This line has a break point set on it is in the browser's developer tool!");
console.log("after break point!");
/*To use breakpoints, open this code in your browser, open the developer tools,
navigate to the Source tab, find this script, and click on the line number where you want to pause execution.
