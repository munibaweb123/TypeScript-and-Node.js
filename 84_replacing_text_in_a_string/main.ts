...
function replacingString(str:string){
    return str.replace (/JavaScript/g,"TypeScript");// here JavaScript is replaced by Typescript
}

console.log(replacingString(`I learn JavaScript, and JavaScript is awesome!`));